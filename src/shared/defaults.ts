...
export function createDefaultSettings(outputDirectory: string): AppSettings {
  return {
    ...
    backupEnabled: true,
    automaticSpreadsheetEnabled: true,
    automaticClosingReportEnabled: false,
    reportExportSections: ["products", "categories", "tables", "times"],
    rememberHistoryPeriod: true,
    rememberReportPeriod: false,
    defaultType: "Venda",
    defaultPeople: 1,
