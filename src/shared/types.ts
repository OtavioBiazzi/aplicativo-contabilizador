...
export type ReportExportSection = "products" | "categories" | "tables" | "times";
...
export interface AppSettings {
  ...
  automaticSpreadsheetEnabled: boolean;
  automaticClosingReportEnabled: boolean;
  reportExportSections: ReportExportSection[];
  rememberHistoryPeriod: boolean;
  rememberReportPeriod: boolean;
  defaultType: EntryType;
  defaultPeople: number;
  defaultRoundingStep: number;
  defaultRoundingDirection: RoundDirection;
