...
- Fase 4: parcialmente atendida. Cliente remoto, bloqueio de configuracoes operacionais, fila serial por mesa, confirmacao da mesa gravada pelo servidor, preservacao do carrinho em falha e reenvio periodico de mesas pendentes foram adicionados. Falta validar o modo PDV em resolucao menor e a mesa aberta durante alteracoes remotas.
